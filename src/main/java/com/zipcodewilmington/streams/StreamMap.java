...
public class StreamMap {
    ...
    public static Stream<Stream<String>> wordsMap(String... someWords) {
        return Arrays.stream(someWords).map(e -> e.codePoints().mapToObj(c -> String.valueOf((char) c)));
    }
    ...
    public static Stream<String> wordsFlatMap(String... stringArray) {
        return Arrays.stream(stringArray).map(e -> e.codePoints().flatMap(c -> IntStream.of((char) c)).toString());
    }
}